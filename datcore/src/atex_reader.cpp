...
// Portable copy of GuildWarsMapBrowser AtexReader.cpp (ATEX header parse +
// DXT1/3/5 block decode -> RGBA). Only the platform include was changed.
#include "datcore/texture_atex.h"
#include "datcore/atex_decompress.h"
#include "datcore/msvc_compat.h"   // __int64 shim (used by the DXT alpha tables)
#include <cstdint>
#include <cstdio>
#include <cstring>
#include <cstdlib>
