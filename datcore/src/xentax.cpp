// Ported verbatim from GuildWarsMapBrowser / GWDatBrowser.
// Guild Wars .dat block codec (Huffman + LZ back-references) by BoyC & BlackDragon.
// ONLY the platform include line was changed here; the decode logic is UNMODIFIED.
