#pragma once
// Portable subset of GuildWarsMapBrowser Vertex.h: the FVF (flexible vertex
// format) decode logic + D3DFVF constants. The D3D11 GWVertex/inputLayoutDesc
// were removed (render-only).
#include <cstdint>
#include <cassert>
