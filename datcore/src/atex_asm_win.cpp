// GW ATEX pre-DXT unpack — 32-bit x86 MSVC __asm (naked). WINDOWS-ONLY: compiled
// into datcore only under 32-bit MSVC (see CMakeLists DATCORE_HAVE_ATEX_ASM),
// giving full-fidelity texture decode where the asm runs. Verbatim from GWMB
// except this include block. Never compiled on macOS/clang (uses atex_stub.cpp).
